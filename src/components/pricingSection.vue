      ...
      <v-row align="center" justify="center">
        <v-col cols="10">
          <v-card style="width: 100%">
            <p class="text-center pt-6 font-weight-light display-2">Millions trust GigSalad to electrify their events.
</p>
              ...
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text-uppercase blue--text">Bands and Groups</div>
                    <v-divider class="my-2"/>
              ...
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Singers</div>
                    <v-divider class="my-2"/>
              ...
              <v-col class="col-12 col-md-4">
                ...
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text--disabled text-uppercase text-h5 my-2">Enterprise</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Circus And Arcabotic</div>
                    <v-divider class="my-2"/>
